    ...
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <article className="rounded-2xl border border-yellow-200 bg-yellow-50 p-5 shadow-sm">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-yellow-700">Em negociação</p>
          <p className="mt-2 text-3xl font-extrabold text-yellow-900">{activePipeline}</p>
        </article>
