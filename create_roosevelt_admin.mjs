...
const adminEmail = 'roosevelt.miranda@gmail.com'
const adminPassword = '120465@'
const adminName = 'Roosevelt Miranda'
...
async function createAdmin() {
    ...
    // O trigger do banco pode já ter criado a linha, usamos upsert para garantir a role.
